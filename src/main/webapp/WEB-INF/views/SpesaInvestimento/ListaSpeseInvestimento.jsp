...
<meta charset="ISO-8859-1">
	<title>Lista Spesa Investimento</title>
...
<a class="btn btn-light" href="http://localhost:8080/Budget/Lista" role="button">Indietro</a>
<body>
	<div class="container">
	  	<h2>Lista Spesa Investimento</h2>
		    	...
		    	<c:forEach items="${elencoSpeseInvestimento}" var="elenco">
		     	<tr>
		     		<td>${elenco.spesaInvestimento}</td>
		      		...
		      		<td>
		      			<spring:url value="/SpesaInvestimento/EditSpesaInvestimento/${elenco.idSpesaInvestimento}" var="editURL" />
		      			<a href="${editURL}" role="button" class="btn btn-primary">Modifica</a>
		      		</td>
		      		<td>
		      			<spring:url value="/SpesaInvestimento/DeleteSpesaInvestimento/${elenco.idSpesaInvestimento}" var="deleteURL" />
