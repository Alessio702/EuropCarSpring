...
<head>
	...
	<title>Edit FatturaPassiva</title>
				   	...
				   	<tbody>
				   		<c:forEach items="${elencoDettagli}" var="elenco">
			   				<tr>
			   					...
			   					<td>
					      			<spring:url value="/FatturaPassiva/DeleteFatturaPassivaDettaglio/${elenco.idDettaglioFattura}/${elenco.identifier}" var="deleteURL" />
